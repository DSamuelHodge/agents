...
- What happens when request body exceeds 256 KB (should return 413 with guidance)?
- How is a featureRequest longer than 8k characters summarized before LLM calls?
